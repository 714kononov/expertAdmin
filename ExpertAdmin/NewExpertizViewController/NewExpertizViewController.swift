...
class NewExpertizViewController: UIViewController {
    ...
    func fetchExpertCount(for typeExpertiz: Int) -> Int {
        var count = 0
        let query = "SELECT COUNT(*) FROM orders WHERE typeExpertiz = ? AND result = 2"
    ...
    @objc func buttonTapped(_ sender: UIButton) {
        ...
        let storyboard = UIStoryboard(name: "ActualViewController", bundle: nil)
        let vsa = storyboard.instantiateViewController(withIdentifier: "ActualViewController") as! ActualViewController
